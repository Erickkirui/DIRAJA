...
# Import all views (removed duplicates)
...
from Server.Views.Shopstockviews import (
    ShopStockDelete, GetShopStock, GetShopStockByShopId, GetAllStock, UpdateShopStockUnitPrice,
    AvailableItemsByShopResource, ItemDetailsResourceForShop, TransferSystemStock, GetItemsByShopId,
    BatchDetailsResource, AvailableBatchesResource, AvailableBatchesByShopResource, BatchDetailsResourceForShop,
    GetBatchStock, GetItemStock, GetStockValueByShop, TotalStockValue, ShopStockByDate
)
from Server.Views.Inventoryviews import (
    AddInventory, GetAllInventory, InventoryResourceById, DistributeInventory, GetTransfer,
    ManualTransfer, StockDeletionResource, DeleteShopStock, GetInventoryByBatch, UpdateTransfer, GetTransferById
)
from Server.Views.Mabandafarmviews import (
    AddMabandaStock, AddMabandaExpense, AddMabandaPurchase, AddMabandaSale, MabandaSaleResource,
    MabandaPurchaseResource, MabandaStockResource, MabandaExpenseResource, TotalAmountPaidSalesMabanda,
    MabandaProfitLossAPI
)
from Server.Views.LiveStock import (
    GetStock, RegisterStock, CheckInStock, CheckoutStock, DeleteStock, AddStock,
    GetAllLiveStock, TransferStock, GetShopTransfers, AutoCheckoutStock
)
...
from Server.Views.Employeeviews import (
    AddNewemployee, GetAllemployees, Employeeresource, UpdateEmployeeShop, GetEmployeeLeaderboard
)
from Server.Views.employeeloanview import AddEmployeeLoan, GetEmployeeLoan
from Server.Views.Sales import (
    AddSale, GetSales, GetSalesByShop, SalesResources, GetPaymentTotals, SalesBalanceResource,
    TotalBalanceSummary, UpdateSalePayment, GetUnpaidSales, PaymentMethodsResource, CapturePaymentResource,
    CreditHistoryResource, GetSingleSaleByShop, SalesByEmployeeResource, GetUnpaidSalesByClerk, GetSale
)
from Server.Views.ManagerDashbordViews import (
    TotalAmountPaidExpenses, TotalAmountPaidSalesPerShop, CountEmployees, CountShops,
    TotalAmountPaidAllSales, TotalAmountPaidPerShop, TotalAmountPaidPurchases, StockAlert,
    TotalSalesByShop, TotalUnpaidAmountAllSales, TotalAmountPaidForMabanda, TotalAmountPaidPurchasesInventory,
    SalesSummary, TotalFinancialSummary, TotalUnpaidAmountPerClerk, TotalExpensesForMabanda
)
from Server.Views.Emailnotifications import Report
from Server.Views.Accountingviews import (
    AccountTypeResource, AccountTypeListResource, CreateAccount, CreateChartOfAccounts,
    ChartOfAccountsList, CreateItemAccount, GetAllItemAccounts, SalesLedger, PurchasesLedger
)
from Server.Views.AccountBalances import (
    PostBankAccount, DepositToAccount, BankAccountResource, GetAllBankAccounts,
    DailySalesDeposit, TotalBankBalance
)
