...
class CostOfSaleLedger(db.Model):
    __tablename__ = "cost_of_sale_ledger"
    ...
    sale = db.relationship("Sales", backref="cost_ledger_entries")
    ...
    inventory = db.relationship("InventoryV2", backref="ledger_inventory_entries")
